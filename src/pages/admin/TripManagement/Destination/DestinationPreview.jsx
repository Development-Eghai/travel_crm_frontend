                        ...
                        <SwiperSlide>
                            ...
                            >
                                ...
                                <div className='destination-slide-content'>
                                    <h3 className="dest-package-name text-center">{destinationContent?.destination_name}</h3>
                    ...
                    <section className='section-padding'>
                        <div className="container">
                            <div className='destination-about-tour'>
                                ...
                                <h5 className='fw-bold mb-4'>About {destinationContent?.destination_name} Packages</h5>
                                ...
                                <div className={`destination-about-tour-content ${readMore ? 'destination-about-tour-content-expand' : ''}`}>
                                    {showReadMore && (
                                        <div className='destination-read-more-main'>
                                            <button className='destination-read-more-btn' onClick={() => setReadMore(!readMore)}>
                                                {readMore ? 'Read Less...' : 'Read More...'}
                                            </button>
                                        </div>
                                    )}
                                    <div ref={contentRef}>
                                        <p dangerouslySetInnerHTML={{ __html: destinationContent?.about_destination || "<p>No description available</p>" }}></p>
                                    </div>
                                </div>
